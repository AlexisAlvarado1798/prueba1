 ...
 */
@Entity
@Table(name = "ACCIONPERMITIDAPLANTILLA", catalog = "", schema = "ALEX")
@XmlRootElement
@NamedQueries({
...
public class Accionpermitidaplantilla implements Serializable {
    ...
    public String toString() {
        return "prueba.jpa.entidades.Accionpermitidaplantilla[ pkAccionpermitidaplantilla=" + pkAccionpermitidaplantilla + " ]";
    }
