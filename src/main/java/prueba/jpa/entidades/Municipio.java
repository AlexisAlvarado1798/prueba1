 ...
 */
@Entity
@Table(name = "MUNICIPIO", catalog = "", schema = "ALEX", uniqueConstraints = {
...
public class Municipio implements Serializable {
    ...
    @OneToMany(mappedBy = "fkMunicipioorigen")
    ...
    public String toString() {
        return "prueba.jpa.entidades.Municipio[ pkMunicipio=" + pkMunicipio + " ]";
    }
