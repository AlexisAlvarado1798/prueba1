 ...
 */
@Entity
@Table(name = "GENERO", catalog = "", schema = "ALEX", uniqueConstraints = {
...
public class Genero implements Serializable {
    ...
    @Id
     @SequenceGenerator(name = "SQGENERO", sequenceName = "SQGENERO", initialValue = 1, allocationSize = 1)
    ...
    public String toString() {
        return "prueba.jpa.entidades.Genero[ pkGenero=" + pkGenero + " ]";
    }
