...
import prueba.jpa.entidades.Plantillaaccionpermitida;
import prueba.jsf.controladores.util.JsfUtil;
import prueba.jsf.controladores.util.PaginationHelper;
import prueba.ejb.fachadas.PlantillaaccionpermitidaFacade;
...
public class PlantillaaccionpermitidaController implements Serializable {
    ...
    @EJB
    private prueba.ejb.fachadas.PlantillaaccionpermitidaFacade ejbFacade;
    ...
    public String create() {
        try {
            ...
            JsfUtil.addSuccessMessage(ResourceBundle.getBundle("/resourcesBundle").getString("PlantillaaccionpermitidaCreated"));
    ...
    public String update() {
        try {
            ...
            JsfUtil.addSuccessMessage(ResourceBundle.getBundle("/resourcesBundle").getString("PlantillaaccionpermitidaUpdated"));
            return "View";
        } catch (Exception e) {
            JsfUtil.addErrorMessage(e, ResourceBundle.getBundle("/resourcesBundle").getString("PersistenceErrorOccured"));
            return null;
    ...
    private void performDestroy() {
        try {
            ...
            JsfUtil.addSuccessMessage(ResourceBundle.getBundle("/resourcesBundle").getString("PlantillaaccionpermitidaDeleted"));
        } catch (Exception e) {
            JsfUtil.addErrorMessage(e, ResourceBundle.getBundle("/resourcesBundle").getString("PersistenceErrorOccured"));
        }
    }
