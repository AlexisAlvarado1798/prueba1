...
public class RespuestaController implements Serializable {
    ...
    @EJB
    private prueba.ejb.fachadas.RespuestaFacade ejbFacade;
    ...
    public String create() {
        try {
            ...
            JsfUtil.addSuccessMessage(ResourceBundle.getBundle("/resourcesBundle").getString("RespuestaCreated"));
    ...
    public String update() {
        try {
            ...
            JsfUtil.addSuccessMessage(ResourceBundle.getBundle("/resourcesBundle").getString("RespuestaUpdated"));
            return "View";
        } catch (Exception e) {
            JsfUtil.addErrorMessage(e, ResourceBundle.getBundle("/resourcesBundle").getString("PersistenceErrorOccured"));
            return null;
    ...
    private void performDestroy() {
        try {
            ...
            JsfUtil.addSuccessMessage(ResourceBundle.getBundle("/resourcesBundle").getString("RespuestaDeleted"));
        } catch (Exception e) {
            JsfUtil.addErrorMessage(e, ResourceBundle.getBundle("/resourcesBundle").getString("PersistenceErrorOccured"));
        }
    }
    ...
    public Respuesta getRespuesta(java.math.BigDecimal id) {
    ...
    public static class RespuestaControllerConverter implements Converter {
        ...
        public String getAsString(FacesContext facesContext, UIComponent component, Object object) {
            ...
            if (object instanceof Respuesta) {
                ...
                return getStringKey(o.getPkRespuesta());
            } else {
