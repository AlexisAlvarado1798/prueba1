...
public class PreguntaController implements Serializable {
    ...
    @EJB
    private prueba.ejb.fachadas.PreguntaFacade ejbFacade;
    ...
    public String create() {
        try {
            ...
            JsfUtil.addSuccessMessage(ResourceBundle.getBundle("/resourcesBundle").getString("PreguntaCreated"));
    ...
    public String update() {
        try {
            ...
            JsfUtil.addSuccessMessage(ResourceBundle.getBundle("/resourcesBundle").getString("PreguntaUpdated"));
            return "View";
        } catch (Exception e) {
            JsfUtil.addErrorMessage(e, ResourceBundle.getBundle("/resourcesBundle").getString("PersistenceErrorOccured"));
            return null;
    ...
    private void performDestroy() {
        try {
            ...
            JsfUtil.addSuccessMessage(ResourceBundle.getBundle("/resourcesBundle").getString("PreguntaDeleted"));
        } catch (Exception e) {
            JsfUtil.addErrorMessage(e, ResourceBundle.getBundle("/resourcesBundle").getString("PersistenceErrorOccured"));
        }
    }
    ...
    public Pregunta getPregunta(java.math.BigDecimal id) {
    ...
    public static class PreguntaControllerConverter implements Converter {
        ...
        public String getAsString(FacesContext facesContext, UIComponent component, Object object) {
            ...
            if (object instanceof Pregunta) {
                ...
                return getStringKey(o.getPkPregunta());
            } else {
